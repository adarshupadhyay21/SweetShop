    ...
    return (
        <div className="min-h-[70vh] flex items-center justify-center p-6">
            <div className="w-full max-w-md bg-white rounded-2xl p-8 shadow-md border border-gray-100">
                ...
                <p className="text-sm text-gray-500 mb-4">Sign in to access your Sweet Shop account</p>
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="flex items-center gap-3 mt-4">
                        <button className="bg-purple-600 hover:bg-purple-700 text-white font-semibold py-2 px-4 rounded-lg" type="submit">Login</button>
                        <Link className="text-purple-600 font-medium" to="/register">Create account</Link>
                    </div>
                    <div className="text-sm text-gray-500 mt-4">By signing in you agree to our terms.</div>
                </form>
            </div>
        </div>
    );
